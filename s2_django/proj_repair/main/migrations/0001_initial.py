# Generated by Django 3.2.25 on 2024-06-26 04:13
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('otdel', models.CharField(db_index=True, max_length=32, verbose_name='Отдел')),
            ],
            options={
                'verbose_name': 'Отдел',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('equipment_name', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to='main.equipment_name_db', verbose_name='Наименование')),
                ('otdel', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to='main.otdel_db', verbose_name='Отдел')),
            ],
            options={
                'verbose_name': 'Тенику',
